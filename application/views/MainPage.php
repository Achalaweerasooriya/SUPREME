...
<title>SUPREME | Agile Project Management Tool</title>   
...
<div id="home-slider">	
    ...
    <div class="slider-text">
    	<div id="slidecaption">SUPREME</div>
    </div>   
...
<header>
    <div class="sticky-nav">
        ...
        <div id="logo">
        	<a id="goUp" href="#home-slider" title="Supreme">Supreme</a>
        </div>
		...
		<li><a href="LoginController" class="external">User Login</a></li>
                <li><a href="LoginController/ClientLoginView" class="external">Client Login</a></li>
            </ul>
        </nav>
    ...
    <div class="row">
        <div class="span12">
            <div class="title-page">
                ...
                <h3 class="title-description">Learn About our Team,Features &amp; Vision.</h3>
            </div>
        </div>
    </div>
    <!-- End Title Page -->
    ...
    <div class="row">
    	...
    	<div class="span4 profile">
        	<div class="image-wrap">
                <div class="hover-wrap">
                    <span class="overlay-img"></span>
                    <span class="overlay-text-thumb">our TEAM</span>
                </div>
                <img src="_include/img/profile/profile-01.jpg" alt="John Doe">
            </div>
          <h3 class="profile-name">CO-FOUNDERS</h3>
          <p class="profile-description">A.Weerasooriya<br>T.Ranathunga<br>
          J.Wasala<br>
          C.Gamaethige
          <br>
          We are Undergraduates of Sri Lanka Institute of Information Technology. 
    	...
    	<div class="span4 profile">
        	<div class="image-wrap">
                <div class="hover-wrap">
                    <span class="overlay-img"></span>
                    <span class="overlay-text-thumb">FeATURES </span>
                </div>
                <img src="_include/img/profile/profile-02.jpg" alt="Jane Helf">
            </div>
            <h3 class="profile-name">FEATURES</h3>
            <p class="profile-description">Project Scheduling<br> 
              Task Management<br> Risk Management<br>
             Effective dash boards <br>Reports<br>  Documentation and many more</p>
            <div class="social">
            	<ul class="social-icons">
    	...
    	<div class="span4 profile">
        	<div class="image-wrap">
                <div class="hover-wrap">
                    <span class="overlay-img"></span>
                    <span class="overlay-text-thumb">Why supreme</span>
                </div>
                <img src="_include/img/profile/profile-03.jpg" alt="Joshua Insanus">
            </div>
            <h3 class="profile-name">WHY SUPREME?</h3>
            <p>Essentially, we started Supreme with a vision of building Agile project management<br>
              software that will empower users to make project decisions through collaboration and right access to knowledge.Users will sure experience a better way on handling projects by using SUPREME.            </p>
            <div class="social">
              <ul class="social-icons">
    ...
    <div class="row">
        <div class="span12">
            <div class="title-page">
                ...
                <h3 class="title-description">We look forward to serving you.</h3>
            </div>
        </div>
    </div>
    <!-- End Title Page -->
    ...
    <div class="row">
        ...
        <div class="span3">
        	<div class="contact-details">
                ...
                <ul>
                    <li><a href="#">info@supreme.com</a></li>
                    <li>071-3456456</li>
                    <li>Supreme Technologies<br>
                        N0 10,Flower Road<br> Colombo</li>
                </ul>
            </div>
        </div>
    </div>
...
<!-- Footer -->
<footer>
	<p class="credits">&copy;2016 <a href="http://themes.alessioatzeni.com/html/brushed/" title="Supreme | Agile project Management tool">Supreme | Agile project Management tool</a></p>
</footer>
<!-- End Footer -->
