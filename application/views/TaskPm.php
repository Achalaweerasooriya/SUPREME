...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?php echo base_url();?>_include/admin/css/sb-admin.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="<?php echo base_url();?>_include/admin/css/plugins/morris.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="h<?php echo base_url();?>_include/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <script src="<?php echo base_url();?>_include/plugins/morris/morris.min.js"></script>
    <script src="<?php echo base_url();?>_include/plugins/morris/morris-data.js"></script>
